...
class LoginVarification extends StatefulWidget {
  static String id = 'login-verification';

  @override
  _LoginVarificationState createState() => _LoginVarificationState();
}

class _LoginVarificationState extends State<LoginVarification> {
