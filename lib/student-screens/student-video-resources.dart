...
class StudentVideoResources extends StatefulWidget {
  static String id = 'video-resources';

  @override
  _StudentVideoResourcesState createState() => _StudentVideoResourcesState();
}

class _StudentVideoResourcesState extends State<StudentVideoResources> {
