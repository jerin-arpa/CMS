...
class StudentImageResources extends StatefulWidget {
  static String id = 'image-resources';

  @override
  _StudentImageResourcesState createState() => _StudentImageResourcesState();
}

class _StudentImageResourcesState extends State<StudentImageResources> {
